...
const Layout: React.FC<{
    ...
    return (
        <div className="flex h-screen bg-apex-900 overflow-hidden font-sans selection:bg-emerald-500 selection:text-white">
            {/* Sidebar */}
            <aside className="w-64 bg-apex-900 border-r border-apex-800 flex flex-col p-4 shadow-xl z-10" aria-label="Main navigation">
                {/* Logo */}
            ...
            {/* Main Content Area */}
            <main className="flex-1 relative bg-gradient-to-br from-apex-900 via-apex-900 to-[#0f1f1a] overflow-hidden">
                {children}
            </main>
        </div>
    );
