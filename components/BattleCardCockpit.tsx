...
<body>
    ...
    return (
        <div className="fixed inset-y-0 right-0 left-0 md:left-auto md:w-[700px] bg-apex-900 border-l border-apex-700 shadow-2xl transform transition-transform duration-300 z-50 flex flex-col font-sans">
            ...
            {/* 1. Hero Header - Enhanced with Archetype */}
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 p-6 md:p-8 relative">
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-2 text-sm text-white/80">
                            ...
                            <span><i className="fa-solid fa-briefcase mr-1"></i> {candidate.yearsExperience} years</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-3xl font-bold text-white min-w-[80px] text-right">
                            {candidate.alignmentScore}%
                        </div>
                        <div className={`px-3 py-1 rounded-full text-xs font-semibold ${getMatchLevel(candidate.alignmentScore).bgColor} ${getMatchLevel(candidate.alignmentScore).color}`}>
                            {getMatchLevel(candidate.alignmentScore).label}
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 mt-4">
                    <button
                        ...
                        className="text-xs text-white/90 hover:text-white flex items-center bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition-colors backdrop-blur-sm"
                                    ...
                                    <div className="mt-6 bg-apex-900/50 rounded-lg p-4 border border-apex-700/50">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            <div className="bg-red-900/10 border border-red-500/20 rounded p-3">
                                                <div className="text-xs font-bold text-red-400 mb-1">🔴 Red Flag</div>
                                            ...
                                            <div className="bg-amber-900/10 border border-amber-500/20 rounded p-3">
                                                <div className="text-xs font-bold text-amber-400 mb-1">🟡 Needs Probing</div>
                                            ...
                                            <div className="bg-emerald-900/10 border border-emerald-500/20 rounded p-3">
                                                <div className="text-xs font-bold text-emerald-400 mb-1">🟢 Strong Signal</div>
