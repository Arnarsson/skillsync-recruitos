                    ...
                    >
                        ...
                        {activeTab === 'evidence' && (
                            <>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <>
                                                <div className="grid grid-cols-2 gap-3 mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-xs font-medium text-purple-400 capitalize">{candidate.persona.careerTrajectory.promotionFrequency}</div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="bg-slate-800/30 border border-white/[0.08] rounded-lg p-4">
                                        <h4 className="text-xs font-medium text-slate-400 mb-3">
                                            <i className="fa-solid fa-fingerprint mr-2 text-purple-400"></i> Key Indicator
                                        </h4>
                                        {indicators.slice(0, 1).map((ind, i) => (
                                            <div key={i}>
                                                <div className="text-xs font-medium text-purple-400 mb-1">{ind.category}</div>
                                ...
                                {/* Interview Guide */}
                                <div className="bg-slate-800/30 border border-white/[0.08] rounded-lg border-l-2 border-l-indigo-500/50 overflow-hidden">
                                    <div className="p-5">
                                        <div className="flex items-center gap-3 mb-5">
                                            <div className="text-xl">🎯</div>
                                            <div>
                                                <h4 className="text-sm font-medium text-indigo-300">Interview Guide</h4>
                                            ...
                                            {questions.map((q, i) => (
                                                <div key={i} className="bg-slate-800/50 rounded-md p-4 border border-white/[0.05]">
                                                    <div className="flex items-start gap-3 mb-2">
                                                        <div className="w-6 h-6 flex items-center justify-center bg-indigo-500/10 text-indigo-400 rounded text-xs font-medium flex-shrink-0 border border-indigo-500/20">
                                                            {i + 1}
                                                        </div>
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="bg-slate-900/50 rounded p-2 border border-white/[0.05]">
                                                                <div className="text-xs font-medium text-indigo-400 mb-1 flex items-center">
                        ...
                        {activeTab === 'company' && candidate.companyMatch && (
                            <div className="bg-slate-800/30 border border-white/[0.08] rounded-lg overflow-hidden">
                                ...
                                <div className="p-4">
                                    <p className="text-sm text-slate-300 leading-relaxed mb-5 border-l-2 border-purple-500/30 pl-3">
